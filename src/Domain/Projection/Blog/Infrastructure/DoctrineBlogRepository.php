...
class DoctrineBlogRepository implements BlogRepository
{
    ...
    public function findAll()
    {
        ...
        foreach ($records as $row) {
            $blogs->append(Blog::create($row['id'], $row['name'], $row['author']));
        }
        return $blogs;
    }
    ...
    public function findById(BlogIdentifier $blogIdentifier): Blog
    {
        ...
        return Blog::create($record['blogId'], $record['blogName'], $record['blogAuthor']);
    }

    public function nextIdentity(): BlogIdentifier
    {
        return BlogIdentifier::fromUuid(Uuid::uuid4());
    }
